...
state varchar(200),
pincode varchar(10),
constraint FO_key foreign key (add_id) references rutvik(id) on delete cascade
);
 INSERT INTO addresses (add_id, street, city, state, pincode)
VALUES
...
rollback;
delete from rutvik where id = 1;

desc addresses;
ALter table addresses 
drop foreign key FO_key;